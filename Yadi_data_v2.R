...
col_addna = c(  
  "aircon", "architectural_style", "framing", 
  "deck", "flag_tub", "heating", "num_pool",
  "pooltypeid10", "pooltypeid2", "pooltypeid7",
  "story", "tax_delinquency"
)
...
dummyfy = c(
  "area_basement", "area_firstfloor_finished",
  "area_liveperi_finished", "area_total_finished",
  "area_unknown", "area_base", "material", 
