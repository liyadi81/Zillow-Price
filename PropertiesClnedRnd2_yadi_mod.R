...
properties.test = properties[,-c("fips", "zoning_landuse_county", "zoning_property",
                                 "tax_year"
)]

properties[properties$tax_delinquency == "Y", "tax_delinquency"] = 1
properties$tax_delinquency = as.numeric(properties$tax_delinquency)

properties[properties$flag_tub == "true", "flag_tub"] = 1
properties$flag_tub = as.numeric(properties$flag_tub)

properties[properties$flag_fireplace == "true", "flag_fireplace"] = 1
properties$flag_fireplace = as.numeric(properties$flag_fireplace)
...
properties_train_working = merge(properties.test, train %>% select(-year), by="id_parcel",all.y=TRUE)

saveRDS(properties.test, file="PropertiesClnedRnd2_yadi_mod.rds")
saveRDS(properties_train_working, file = "TrainClnedRnd2_yadi_mod.rds")
